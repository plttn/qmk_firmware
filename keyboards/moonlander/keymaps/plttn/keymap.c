...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [GAME] = LAYOUT_moonlander(
        ...
        KC_LCTL,_______,_______,KC_LEFT, KC_RGHT,  _______,                       OSL(GAME_FUNC),          KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC, MO(SYMB),
                                            KC_SPC,  KC_LALT, _______,            KC_BSPC,  KC_TAB,  KC_ENT
    ),
    [GAME_FUNC] = LAYOUT_moonlander(
